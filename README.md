...
print("https://discord.gg/xnotzcommunity")
toclipboard("https://discord.gg/xnotzcommunity")
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Xnotz Hub Premium Scripts") then
			makefolder("Xnotz Hub Premium Scripts")
		end
		if not isfolder("Xnotz Hub Premium Scripts/Blox Fruits/") then
			makefolder("Xnotz Hub Premium Scripts/Blox Fruits/")
		end
		if not isfile("Xnotz Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Xnotz Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Xnotz Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Xnotz Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("Xnotz Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
if QuestC.Visible == true then
						...
						local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/minhhau207/XnotzHub/main/obfuscated-3788.lua"))()
